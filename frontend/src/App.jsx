...
import FootballCourtBookingCalendar from "./Components/FootballCourtBookingCalendar/FootballCourtBookingCalendar";
    ...
    <AuthProvider>
      <BrowserRouter>
        <Routes>
          ...
          <Route path="/prueba" element={<FootballCourtBookingCalendar/>}/>
