      ...
      <BrowserRouter>
        <Routes>
          <Route element={<Layout />}>
            ...
            <Route path={routes.productList} element={<ProductList addToFavorites={addToFavorites} />} />
            <Route path="/detalle/:id" element={<Detail addToFavorites={addToFavorites} removeFromFavorites={removeFromFavorites} favorites={favorites} />} />
