  ...
  return (
    ...
    <div className="flex flex-col md:flex-row justify-between items-center py-4 px-8">
        ...
        <div className="flex md:flex-row">
            <a href="https://www.facebook.com/sharer/sharer.php?u=https%3A//easyscore-beta.vercel.app/" className="px-4"><FontAwesomeIcon icon={faFacebookF} /></a>
            <a href="#" className="px-4"><FontAwesomeIcon icon={faInstagram} /></a>
            <a href="https://twitter.com/intent/tweet?text=Encuentren%20las%20mejores%20canchas%20de%20futbol%20en%20https%3A//easyscore-beta.vercel.app/" className="px-4"><FontAwesomeIcon icon={faTwitter} /></a>
            <a href="https://www.linkedin.com/shareArticle?mini=true&url=https%3A//easyscore-beta.vercel.app/" className="px-4"><FontAwesomeIcon icon={faLinkedinIn} /></a>
