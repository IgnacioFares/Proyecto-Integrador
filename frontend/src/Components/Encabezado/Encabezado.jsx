...
export const Encabezado = () => {
  return (
    <section className="flex justify-center items-center w-full h-screen bg-cover bg-center bg-no-repeat" style={{ backgroundImage: "url('https://images.unsplash.com/photo-1574629810360-7efbbe195018?q=80&w=1893&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D')" }}>
      <div className="flex flex-col items-center justify-center text-center px-4 md:px-6 lg:px-8 w-full">
        ...
        <div className="w-full md:w-5/5 lg:w-3/5 mt-4">
          <SearchBar />
        </div>
      </div>
    </section>
